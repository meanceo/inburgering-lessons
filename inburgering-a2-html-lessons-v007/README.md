# Inburgering A2 HTML Lessons - Version 7
...
Version 7 is an existing package folder. Future new-package automation runs must not overwrite this folder or append new lesson material into it.
