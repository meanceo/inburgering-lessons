# Inburgering A2 HTML Lessons - Version 10
...
Version 10 is an existing package folder after this run. Future new-package automation runs must not overwrite this folder or append new lesson material into it.
