# Inburgering A2 HTML Lessons - Version 6
...
Version 6 is an existing package folder. Future new-package automation runs must not overwrite this folder or append new lesson material into it.
