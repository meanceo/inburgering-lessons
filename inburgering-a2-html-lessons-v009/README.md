# Inburgering A2 HTML Lessons - Version 9
...
Version 9 is an existing package folder after this run. Future new-package automation runs must not overwrite this folder or append new lesson material into it.
