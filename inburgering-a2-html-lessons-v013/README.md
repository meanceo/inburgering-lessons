...
Version 13 is an existing package folder after this run. Future new-package automation runs must not overwrite this folder or append new lesson material into it.
