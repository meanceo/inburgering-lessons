...
The interface follows the latest approved v004 design pattern:
...
Version 5 is a completed package. Future automation runs must not overwrite this folder or append new lesson material into it.
